...
public class CustomerModel {
	...
	public long add(CustomerBean bean) throws ApplicationException,DuplicateRecordException{
		...
		Connection conn=null;
		int pk=0;
		 CustomerBean duplicateCustomerName = findByName(bean.getName());
		
		
		if(duplicateCustomerName !=null){
			throw new DuplicateRecordException("Customer Name alredy exists");
	...
	public CustomerBean findByName(String name) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM st_customer WHERE NAME=?");
	...
	public void update(CustomerBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE st_customer SET NAME=?,ADDRESS=?,EMAIL=?,GENDER=?,PHONE_NO=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");

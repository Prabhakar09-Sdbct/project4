...
<body>
	...
	<form action="<%=ORSView.POSITION_CTL%>" method="post">
		...
		<%
		List<PositionBean> clist = (List<PositionBean>) request.getAttribute("positionList");
		%>
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="designation"
						placeholder="Enter Designation" size="26"
				...
				<tr>
					...
					<td><input type="text" name="openingDate" id="udate"
						readonly="readonly" placeholder=" Opening Date" size="26"
				...
				<tr>
					...
					<td><input type="text" name="requiredExperience"
						placeholder="Enter Required Experience" size="26"
				...
				<tr>
					...
					<td style="position: fixed"><font color="red"><%=ServletUtility.getErrorMessage("condition", request)%></font>
					</td>
				</tr>

...
CREATE TABLE `st_position` (
  ...
  `REQUIRED_EXPERIENCE` varchar(15) DEFAULT NULL,
  `CONDN` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `CREATED_BY` varchar(50) DEFAULT NULL,
  `MODIFIED_BY` varchar(50) DEFAULT NULL,
  `CREATED_DATETIME` datetime DEFAULT NULL,
  `MODIFIED_DATETIME` datetime DEFAULT NULL,
...
/*Data for the table `st_position` */

insert  into `st_position`(`ID`,`DESIGNATION`,`OPENING_DATE`,`REQUIRED_EXPERIENCE`,`CONDN`,`CREATED_BY`,`MODIFIED_BY`,`CREATED_DATETIME`,`MODIFIED_DATETIME`) values 
(1,'Software Developer','1981-02-11','Three','OnHold','mandloiprabhakar382@gmail.com','mandloiprabhakar382@gmail.com','2025-02-11 13:34:04','2025-02-11 13:34:04'),
(2,'Software Developer','1985-02-06','One','Open','mandloiprabhakar382@gmail.com','mandloiprabhakar382@gmail.com','2025-02-11 13:33:52','2025-02-11 13:33:52');
